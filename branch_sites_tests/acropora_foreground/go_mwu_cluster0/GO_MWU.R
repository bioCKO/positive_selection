...
setwd("~/gitreps/positive_selection/branch_sites_tests/acropora_foreground/go_mwu_cluster0")
...
gomwuStats(input, goDatabase, goAnnotations, goDivision,
	...
	clusterCutHeight=0, # threshold for merging similar (gene-sharing) terms. See README for details.
...
gomwuPlot(input,goAnnotations,goDivision,
	...
	level3=0.4, # FDR cutoff to print in large bold font.
...
#now switch working directory and rewrite the results
