...
setwd("~/gitreps/positive_selection/branch_sites_tests/acropora_foreground/go_mwu")
...
source("~/gitreps/positive_selection/scripts/gomwu.functions.R")
...
#---------- look at the genes with particular GO annotations ----------
...
lnames=load("~/gitreps/positive_selection/branch_sites_tests/acropora_foreground/branch_sites_results.Rdata")
head(a.pdat)
...
#Genes of Importance (other than ones already shown in concensus_go.R):
# XP_015769911.1	ELAV-like protein 1 (GO=regulation of epithelial to mesenchymal transition)
# XP_015756016.1	uncharacterized protein LOC107335512  (GO=regulation of epithelial to mesenchymal transition)
